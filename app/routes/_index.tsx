...
export default function Index() {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative py-20 lg:py-32 bg-gradient-to-br from-navy-900 to-navy-950">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              {/* Quote */}
              <blockquote className="border-l-4 border-gold-400 pl-6 py-4">
                <p className="quote text-gold-200">
                ...
                <cite className="text-sm text-gold-300 font-medium mt-2 block">— Dr. Vibha Dineshkumar Shah</cite>
              </blockquote>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="font-serif text-3xl font-bold text-gray-900 mb-4">Available Editions</h3>
            <p className="text-lg text-gray-700 font-medium">Choose your preferred format</p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-navy-50 to-gold-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="font-serif text-3xl font-bold text-navy-900 mb-4">Official Publication</h3>
            <p className="text-lg text-gray-700">Professionally published with official ISBN registration</p>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Publisher Information */}
            <div className="card bg-white text-center group hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              <div className="w-12 h-12 bg-gradient-to-br from-navy-100 to-navy-200 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-6 h-6 text-navy-600 group-hover:text-navy-800 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
              </div>
              <h4 className="font-serif text-lg font-semibold text-navy-800 mb-2">Publisher</h4>
              <p className="text-sm text-gray-700 mb-2">Dineshkumar Devchand Shah</p>
              <p className="text-xs text-gray-600">P.O. Box 1801-00606, Nairobi</p>
            </div>

            {/* Copyright Information */}
            <div className="card bg-white text-center group hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
              <div className="w-12 h-12 bg-gradient-to-br from-gold-100 to-gold-200 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-6 h-6 text-gold-600 group-hover:text-gold-700 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <h4 className="font-serif text-lg font-semibold text-navy-800 mb-2">Copyright</h4>
              <p className="text-sm text-gray-700 mb-2">© Copyright 2025</p>
              <p className="text-xs text-gray-600">Board No.: RZ79824</p>
            </div>
            ...
            <div className="card bg-white text-center md:col-span-2 lg:col-span-1">
              ...
              <h4 className="font-serif text-lg font-semibold text-navy-800 mb-2">Published</h4>
              <p className="text-sm text-gray-700 mb-2">August 2025</p>
              <p className="text-xs text-gray-600">Nairobi, Kenya</p>
            </div>
          </div>

          {/* Additional Publication Details */}
          <div className="mt-12 bg-white rounded-xl p-6 shadow-lg border border-navy-100">
            <h4 className="font-serif text-xl font-semibold text-navy-900 mb-6 text-center">Publication Details</h4>
            <div className="grid md:grid-cols-2 gap-6 text-sm">
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="font-medium text-gray-700">Paperback ISBN:</span>
                  <span className="font-mono text-navy-900">978-9914-35-124-8</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-medium text-gray-700">Hardback ISBN:</span>
                  <span className="font-mono text-navy-900">978-9914-35-125-5</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-medium text-gray-700">Copyright Board:</span>
                  <span className="font-mono text-navy-900">RZ79824</span>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="font-medium text-gray-700">Website:</span>
                  <span className="text-navy-900">www.inquestofknowledge.com</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-medium text-gray-700">Email:</span>
                  <span className="text-navy-900">info@inquestofknowledge.com</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="font-medium text-gray-700">Language:</span>
                  <span className="text-navy-900">English</span>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed italic">
                "Celebrating a life of extraordinary achievements and quiet strength"
              </p>
              <p className="text-gray-400 text-sm mt-2">
                Published August 2025 • Nairobi, Kenya
              </p>
            </div>
            <div>
