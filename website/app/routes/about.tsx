    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-gradient-to-br from-primary-50 to-gold-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-serif text-4xl lg:text-5xl font-bold text-primary-900 mb-6">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="card">
                <h2 className="font-serif text-2xl font-bold text-primary-900 mb-6">Her Extraordinary Journey</h2>
                <div className="prose prose-lg text-primary-700 space-y-4">
                  <p>
              ...
              <div className="card">
                <h3 className="font-serif text-xl font-bold text-primary-900 mb-4">Professional Excellence</h3>
                <div className="prose text-primary-700 space-y-4">
                  <p>
                    After completing her graduation, Vibha worked at the Hammersmith Hospital as well as Boot's the Chemist. She eventually completed her registration with the Pharmaceutical Society of Great Britain, attaining the license to practise within the boundaries of Britain.
                  </p>
                  <p>
              ...
              <div className="card">
                <h3 className="font-serif text-xl font-bold text-primary-900 mb-4">A Life of Learning</h3>
                <div className="prose text-primary-700 space-y-4">
                  <p>
            ...
            <div className="space-y-6">
              ...
              <div className="card">
                <h3 className="font-serif text-xl font-bold text-primary-900 mb-4">Quick Facts</h3>
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    <span className="font-medium text-primary-800">Born:</span>
                    <span className="text-primary-600">1950s, Nairobi, Kenya</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium text-primary-800">Education:</span>
                    <span className="text-primary-600">Cardiff University</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium text-primary-800">Qualifications:</span>
                    <span className="text-primary-600">MPharm, FCCA, MBA</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium text-primary-800">Marriage:</span>
                    <span className="text-primary-600">1978 (42 years)</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium text-primary-800">Children:</span>
                    <span className="text-primary-600">Shail, Shrena, Preksha</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="font-medium text-primary-800">Passed Away:</span>
                    <span className="text-primary-600">October 2021</span>
                  </div>
                </div>
              </div>

              <div className="card">
                <h3 className="font-serif text-xl font-bold text-primary-900 mb-4">Her Philosophy</h3>
                <blockquote className="border-l-4 border-primary-400 pl-4 py-2">
                  <p className="quote text-base text-primary-800 mb-3">
              ...
              <div className="card">
                <h3 className="font-serif text-xl font-bold text-primary-900 mb-4">About the Author</h3>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-serif text-3xl font-bold text-primary-900 mb-4">What's Inside</h2>
            <p className="text-lg text-primary-600">A comprehensive look at an extraordinary life</p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
              <h3 className="font-serif text-xl font-semibold text-primary-800">Main Chapters</h3>
              <div className="space-y-3">
                <div className="border-l-4 border-primary-300 pl-4">
                  <h4 className="font-medium text-primary-800">Chapter 1: The Spark of Learning</h4>
                  <p className="text-sm text-primary-600">Early life and education in Nairobi</p>
                </div>
                <div className="border-l-4 border-primary-300 pl-4">
                  <h4 className="font-medium text-primary-800">Chapter 2: Becoming Vibha</h4>
                  <p className="text-sm text-primary-600">University years in Cardiff</p>
                </div>
                <div className="border-l-4 border-primary-300 pl-4">
                  <h4 className="font-medium text-primary-800">Chapter 3: Love, Letters, and a New Beginning</h4>
                  <p className="text-sm text-primary-600">Marriage and new life chapter</p>
                </div>
                <div className="border-l-4 border-primary-300 pl-4">
                  <h4 className="font-medium text-primary-800">Chapter 4: Grit and Grace in Foreign Lands</h4>
                  <p className="text-sm text-primary-600">Professional career and challenges</p>
                </div>
              </div>
            </div>

            <div className="space-y-6">
              <h3 className="font-serif text-xl font-semibold text-primary-800">Special Features</h3>
              <div className="space-y-3">
                <div className="border-l-4 border-gold-300 pl-4">
                  <h4 className="font-medium text-primary-800">Chapter 5: Through the Lens of Travel</h4>
                  <p className="text-sm text-primary-600">Lessons from around the world</p>
                </div>
                <div className="border-l-4 border-gold-300 pl-4">
                  <h4 className="font-medium text-primary-800">Chapter 7: Testimonials</h4>
                  <p className="text-sm text-primary-600">Memories from family and friends</p>
                </div>
                <div className="border-l-4 border-gold-300 pl-4">
                  <h4 className="font-medium text-primary-800">Appendix</h4>
                  <p className="text-sm text-primary-600">Origins of Halari Visa Oshwal Community</p>
                </div>
              </div>
            </div>
          </div>
